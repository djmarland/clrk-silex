'use strict';
// Source: public/static/src/js/vendor/angular-route.min.js
/*
...
;// Source: public/static/src/js/vendor/angular.js
/**
...
!window.angular.$$csp() && window.angular.element(document).find('head').prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\\:form{display:block;}</style>');;// Source: public/static/src/js/app/Model/customer.js

var cus = 'yo';;// Source: public/static/src/js/app/one.js
(function() {
alert('one');
})();;// Source: public/static/src/js/app/two.js
(function() {
alert('two');
})();;// Source: public/static/src/js/bootstrap.js
(function() {
